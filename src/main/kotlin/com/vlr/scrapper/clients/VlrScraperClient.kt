...
import com.vlr.scrapper.model.vlr.TeamPlayer
import com.vlr.scrapper.model.vlr.TeamMatch
import com.vlr.scrapper.model.vlr.EventPlacement
import com.vlr.scrapper.model.vlr.PlacementResult
import com.vlr.scrapper.model.vlr.RatingHistoryEntry
import com.vlr.scrapper.model.vlr.FormRating
import com.vlr.scrapper.model.vlr.RankingHistoryEntry
import com.vlr.scrapper.model.vlr.Player
import com.vlr.scrapper.model.vlr.PastTeam
import com.vlr.scrapper.model.vlr.LiveMatch
import com.vlr.scrapper.model.vlr.EventDetail
import com.vlr.scrapper.model.vlr.EventTeam
import com.vlr.scrapper.model.vlr.EventBracketGroup
import com.vlr.scrapper.model.vlr.EventBracketRound
import com.vlr.scrapper.model.vlr.EventBracketMatch
import com.vlr.scrapper.model.vlr.EventBracketTeam
...
import com.vlr.scrapper.model.vlr.TeamInfo
import com.vlr.scrapper.model.vlr.StreamInfo
import com.vlr.scrapper.model.vlr.MapResult

import com.vlr.scrapper.model.vlr.TeamScore
import com.vlr.scrapper.model.vlr.PlayerMatchStat
import com.vlr.scrapper.model.vlr.SideStat
import com.vlr.scrapper.model.vlr.MapStatsData
import com.vlr.scrapper.model.vlr.MapStats
import com.vlr.scrapper.model.vlr.NewsDetail
import com.vlr.scrapper.model.vlr.Round
import com.vlr.scrapper.model.vlr.ThreadComment
    ...
    fun getNewsDetail(urlStr: String): NewsDetail {
        ...
        contentElement?.select("iframe")?.forEach { iframe ->
            ...
            if (src.contains("youtube.com") || src.contains("youtu.be")) {
                ...
                val ytElement = Element("ytlink").text(videoUrl)
        ...
        class MutableComment(
            ...
            fun toThreadComment(): ThreadComment {
               return ThreadComment(this.author, this.content, url, children.map { it.toThreadComment() })
            }
        }
        ...
        return NewsDetail(finalTitle, finalAuthor, finalDate, content, urlStr, roots.map { it.toThreadComment() })
    }
        ...
        for (container in gameContainers) {
            ...
            for (table in tables) {
                ...
                for (row in rows) {
                    ...
                    fun extractSideStat(cell: Element?): SideStat {
